        ...
        <div className="bg-white text-primary-color border border-slate-200 my-5 p-5 md:min-w-[450px]">
          ...
          <div className="grid grid-cols-2 gap-3 my-3">
            <div className="border p-2 rounded-md bg-slate-50">
              ...
              <h1 className="font-bold">TRK92837939</h1>
            </div>
            <div className="border p-2 rounded-md bg-slate-50">
              <small className="text-gray-600">ORDER ID</small>
              <h1 className="font-bold">ORD92837498</h1>
            </div>
            <div className="border p-2 rounded-md bg-slate-50">
            ...
            <div className="border p-2 rounded-md bg-slate-50">
              ...
              <h1 className="font-bold">04 JUNE 2024</h1>
            </div>
          </div>
          <button className="w-full bg-primary-color text-white py-2 border rounded-md mb-2">
            <FontAwesomeIcon icon={faDownload} className="mr-1" /> Download
            Invoice
          </button>
          <button className="w-full bg-black text-white py-2 border rounded-md mb-2">
